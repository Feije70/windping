      ...
      {latest && (
        <div style={{ background: C.card, boxShadow: C.cardShadow, borderRadius: 16, overflow: "hidden", marginBottom: 12 }}>
          ...
          <div style={{ padding: "0 14px 12px", display: "flex", gap: 8 }}>
            ...
            <Link href={`/sessie/${latest.id}`} style={{ display: "flex", alignItems: "center", gap: 6, padding: "8px 14px", background: C.sky + "15", borderRadius: 10, fontSize: 12, fontWeight: 700, color: C.sky, textDecoration: "none" }}>
              Bekijk sessie →
            </Link>
          </div>
        </div>
