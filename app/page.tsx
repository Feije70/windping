    ...
    <div>
      ...
      {latest && (
        <div style={{ background: C.card, boxShadow: C.cardShadow, borderRadius: 16, overflow: "hidden", marginBottom: 12 }}>
          <Link href={`/sessie/${latest.id}`} style={{ display: "block", textDecoration: "none" }}>
            {latest.photo_url && (
          ...
          {/* Deel-knop — buiten de Link zodat klik niet navigeert */}
          <div style={{ padding: "0 14px 12px", display: "flex", gap: 8 }}>
            <a
              ...
              style={{ display: "flex", alignItems: "center", gap: 6, padding: "8px 14px", background: "#25D36615", borderRadius: 10, fontSize: 12, fontWeight: 700, color: "#25D366", textDecoration: "none" }}
            >
            ...
            <Link href={`/sessie/${latest.id}`} style={{ display: "flex", alignItems: "center", gap: 6, padding: "8px 14px", background: "rgba(14,165,233,0.1)", borderRadius: 10, fontSize: 12, fontWeight: 700, color: C.sky, textDecoration: "none" }}>
              Deel sessie →
            </Link>
          </div>
        </div>
