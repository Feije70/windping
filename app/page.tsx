      ...
      {latest && (
        <div style={{ background: C.card, boxShadow: C.cardShadow, borderRadius: 16, overflow: "hidden", marginBottom: 12 }}>
          ...
          <div style={{ padding: "0 14px 12px", display: "flex", gap: 8 }}>
            ...
            <a href={`/sessie/${latest.id}`} style={{ display: "flex", alignItems: "center", gap: 6, padding: "8px 14px", background: "rgba(14,165,233,0.1)", borderRadius: 10, fontSize: 12, fontWeight: 700, color: C.sky, textDecoration: "none" }}>
              Deel sessie →
            </a>
          </div>
        </div>
